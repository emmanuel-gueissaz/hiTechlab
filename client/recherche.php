...
if (isset($_POST['query'])) {
    ...
    $data = '';
    $test = '"';
    $requete = "(select email,nom,prenom,tel,rue,cpost,nomentreprise from  only client where nom like '%" . $_POST['query'] . "%' or prenom like '%" . $_POST['query'] . "%' or tel like '%" . $_POST['query'] . "%' or email  like '%" . $_POST['query'] . "%' limit $limit offset $offest)";
