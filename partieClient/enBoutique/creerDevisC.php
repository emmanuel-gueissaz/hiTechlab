...
<html lang="fr">
    ...
    <body>
        ...
        <div style="text-align: center">
            ...
            <form method="POST" >
                ...
                <div style="text-align: center;">
                    <input type="button"  class="btn btn-outline-danger btn-lg" value="annuler" onclick="document.location.href = '/hitechlab/partieclient/enBoutique/dejaClient.php'"/>
        ...
        if (isset($_POST['creerDevis'])) {
            ...
            try {
                $insert = "select * from creerdevis($modele,'$email',$etat,'$serie','$noteCli','$code','$accessoire','$date','$heure','','','$rapport','$panne', '$inter', '$remplacement', '$defautsav', '$defautreco','$laPanne',true);";
 ...
 >Se connecter </a></div></div>'
                ...
                echo '<script> alert_info_redirect("Demande de devis crée","success","/hitechlab/partieclient/enBoutique/dejaClient.php");</script>';
            } catch (Exception $ex) {
                echo $ex;
