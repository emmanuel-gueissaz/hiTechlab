...
<html lang="fr">
    ...
    <body>
                ...
                <div>
                    ...
                    <form method="POST">
                      ...
                      <h4 class="labelClient"> mot de passe :</h4>  <input type="button" class="inputClient btn btn-outline-primary" value="modifier" onclick="document.location.href='/hitechlab/boutique/modifierMdpTech.php?id=<?php echo $_GET['id'] ?>'" />
                        ...
                        <h4 class="labelClient">Salaire : </h4> <input class="inputClient form-control" type="text" id="Salaire" name="Salaire"/><br>
        ...
        <script src="../lib/js/popper.js" type="text/javascript"></script>
                ...
                $requete = "(select email,nom,prenom,tel,telfixe,rue,cpost,ville,receptionoffre,mdp,salaire from only technicien where email = '" . $_GET['id'] . "')";
        ...
        if (isset($_POST['modifier'])) {
            ...
            try {
                ...
                $update = "update  technicien
                           set (nom,prenom,tel,email,telfixe,rue,cpost,ville,receptionoffre,salaire) = ('$nom','$prenom','$tel','$email','$telFix','$rue','$Cpost','$ville','$offre',$salaire)
                           where email = '$Tmail';";
