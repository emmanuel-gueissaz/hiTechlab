...
<html lang="fr">
    ...
    <body>
                ...
                <div style="text-align: center">
                    ...
                    <div class="cadreView">
                        <div class="titreView">
                            ...
                            <button class="btn btn-primary iconElement" onclick="document.location.href = '/hitechlab/boutique/ajout/ajouterMarque.php'"  >
        ...
        if(isset($_POST['supp'])){
            ...
            try {
                   $requete = "delete from marque where id_marque = $id ;";
            $requete = $conn -> prepare($requete);
            $requete -> execute();
             echo '<script> alert_info_redirect("La marque est supprimée","success","/hitechlab/boutique/view/viewMArque.php");</script>';
            } catch (Exception $ex) {
                  echo '<script> alert_info("La marque ne peut être supprimée","error");</script>';
            }
