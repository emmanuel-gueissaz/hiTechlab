                ...
                <div style="text-align: center">
                    ...
                    <div class="cadreView">
                        <div class="titreView">
                            ...
                            <button class="btn btn-primary iconElement" onclick="document.location.href = '/hitechlab/boutique/ajout/ajouterTypePiece.php'"  >
...
if (isset($_POST['supp'])) {
    ...
    try {
        $requete = "delete from type_piece where id_categ = $id ;";
        $requete = $conn->prepare($requete);
        $requete->execute();
        echo '<script> alert_info_redirect("Le type de piece à été supprimé","success","/hitechlab/boutique/view/viewTypePiece.php");</script>';
    } catch (Exception $ex) {
        echo '<script> alert_info("Le type de piece ne peut être supprimé","error");</script>';
    }
}
?>
