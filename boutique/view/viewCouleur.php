...
<html lang="fr">
    ...
    <body>
                ...
                <div style="text-align: center">
                    ...
                    <div class="cadreView">
                        <div class="titreView">
                            ...
                            <button class="btn btn-primary iconElement" onclick="document.location.href = '/hitechlab/boutique/ajout/ajoutCouleur.php'"  >
                        ...
                        while ($lignes = $requete->fetch()) {
                            $id = $lignes['id_couleur'];
                            $lib = $lignes['lib_couleur'];
        ...
        if(isset($_POST['supp'])){
            ...
            $requete = $conn -> prepare($requete);
            $requete -> execute();
             echo '<script> alert_info_redirect("Couleur supprimée","success","/hitechlab/boutique/view/viewCouleur.php");</script>';
            } catch (Exception $ex) {
                  echo '<script> alert_info("La couleur ne peut être supprimée","error");</script>';
            }
