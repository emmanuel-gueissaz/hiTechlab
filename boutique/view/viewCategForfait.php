...
<html lang="fr">
    ...
    <body>
                    ...
                    <div class="cadreView">
                        <div class="titreView">
                            <h5 class="lableTitreView">
                                Les catégories de forfaits :
                            </h5>
                            <button class="btn btn-primary iconElement" onclick="document.location.href = '/hitechlab/boutique/ajout/ajouterCategorie.php'"  >
        ...
        if(isset($_POST['supp'])){
            ...
            try {
                   $requete = "delete from categorie where id_categ = '$id' ;";
            $requete = $conn -> prepare($requete);
            $requete -> execute();
             echo '<script> alert_info_redirect("La catégorie est supprimée","success","/hitechlab/boutique/view/viewCategForfait.php");</script>';
            } catch (Exception $ex) {
                  echo '<script> alert_info("La catégorie ne peut être supprimée","error");</script>';
            }
