...
<html lang="fr">
    ...
    <body>
                ...
                <div style="text-align: center">
                    ...
                    <div class="cadreView">
                        <div class="titreView">
                            ...
                            <button class="btn btn-primary iconElement" onclick="document.location.href = '/hitechlab/boutique/ajout/ajoutTypeAccessoire.php'"  >
        ...
        if(isset($_POST['supp'])){
            ...
            try {
                   $requete = "delete from type_accessoire where id_type = $id ;";
            $requete = $conn -> prepare($requete);
            $requete -> execute();
             echo '<script> alert_info_redirect("Type supprimé","success","/hitechlab/boutique/view/viewTypeAccessoire.php");</script>';
            } catch (Exception $ex) {
                  echo '<script> alert_info("Le type ne peut être supprimé","error");</script>';
            }
